...
def analyze_document(
    ...
    system_instruction = (
        ...
        "  * If a deadline specifies a day or month (e.g., 'August 20') but the year cannot be confidently determined, "
        "return the exact text representation without inventing a year.\n"
        "  * Assign 'deadline_confidence':\n"
        "    - 'high': Complete date/time explicitly stated with year.\n"
        "    - 'medium': Date partially specified (e.g., day/month given, year omitted or inferred from document context).\n"
        "    - 'low': Ambiguous timeframe or vague reference.\n"
